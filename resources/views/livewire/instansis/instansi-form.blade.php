            ...
            <div class="p-4 max-w-lg">
                ...
                <form wire:submit.prevent="submit" autocomplete="off">
                    <div class="mb-3">
                        ...
                        <input type="text" wire:model.defer="nama_instansi" class="border rounded px-3 py-2 w-full" placeholder="Isi instansi" autofocus>
                        @error('nama_instansi') <span class="text-red-600">{{ $message }}</span> @enderror
                    </div>

                      <div class="mb-3">
                        <label class="block mb-1">Alamat Instansi *</label>
                        <input type="text" wire:model.defer="alamat_instansi" class="border rounded px-3 py-2 w-full" placeholder="Isi alamat instansi" autofocus>
                        @error('alamat_instansi') <span class="text-red-600">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-3">
                        <label class="block mb-1">Telepon Instansi</label>
                        <input type="text" wire:model.defer="telp_instansi" class="border rounded px-3 py-2 w-full">
